...
class GMF(object):
    ...
    def build(self, df):   
        ...
        # Keras Embeddings
        user_embedding = Embedding(input_dim=self.num_users, output_dim=self.embedding_size, name="user_embedding_gmf", weights=[normalized_user_embeddings], trainable=True)(self.user_input)
        item_embedding = Embedding(input_dim=self.num_items, output_dim=self.embedding_size, name="item_embedding_gmf", weights=[normalized_item_embeddings], trainable=True)(self.item_input)
